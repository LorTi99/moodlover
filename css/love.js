(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.moveTo(0, 0);
            ctx.scale(0.75, 0.75);
            ctx.font = "17px 微软雅黑,Verdana"; // 字号肿么没有用? (ˉ(∞)ˉ)
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	ctx.fillStyle = 'rgb(23,0,0)';
            ctx.shadowColor = 'rgb(29,1,1)';
            ctx.shadowBlur = 2;
        	ctx.moveTo(p.x, p.y);
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || 'rgb(225,' + random(0, 255) + ',' + random(0, 255) + ')';
